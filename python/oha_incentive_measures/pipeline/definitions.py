...
class AdolescentWellCare(PRMSASTask):  # pragma: no cover
    ...
    def output(self):
        names_output = {"results_adolescent_well_care.sas7bdat"}
        return [
...
class ColorectralCancerScreening(PRMSASTask):  # pragma: no cover
    ...
    def output(self):
        names_output = {"results_crc_screening.sas7bdat"}
        return [
            IndyPyLocalTarget(PRM_META[(150, "out")] / name) for name in names_output
        ]
...
class DevelopmentalScreening(PRMSASTask):  # pragma: no cover
    ...
    def output(self):
        names_output = {"results_dev_screening.sas7bdat"}
        return [
            IndyPyLocalTarget(PRM_META[(150, "out")] / name) for name in names_output
        ]
...
class EDVisits(PRMSASTask):  # pragma: no cover
    ...
    def output(self):
        names_output = {"results_ed_visits.sas7bdat"}
        return [
            IndyPyLocalTarget(PRM_META[(150, "out")] / name) for name in names_output
        ]
...
class EffectiveContraceptive(PRMSASTask):  # pragma: no cover
    ...
    def output(self):
        names_output = {"results_eff_contra.sas7bdat"}
        return [
            IndyPyLocalTarget(PRM_META[(150, "out")] / name) for name in names_output
        ]
...
class AssessmentsForDHSChildren(PRMSASTask):  # pragma: no cover
    ...
    def output(self):
        names_output = {"results_DHS_assessments.sas7bdat"}
        return [
            IndyPyLocalTarget(PRM_META[(150, "out")] / name) for name in names_output
        ]
...
class EDVisitsMI(PRMSASTask):  # pragma: no cover
    ...
    requirements = RequirementsContainer(EDVisits, staging_emr.Validation)

    def output(self):
        names_output = {"results_ED_Visits_MI.sas7bdat"}
        return [
            IndyPyLocalTarget(PRM_META[(150, "out")] / name) for name in names_output
        ]
...
class DentalSealant(PRMSASTask):  # pragma: no cover
    ...
    def output(self):
        names_output = {"results_Dental_Sealants.sas7bdat"}
        return [
            IndyPyLocalTarget(PRM_META[(150, "out")] / name) for name in names_output
        ]
...
class DiabetesOralEval(PRMSASTask):  # pragma: no cover
    ...
    def output(self):
        names_output = {"results_Diabetes_Oral_Eval.sas7bdat"}
        return [
            IndyPyLocalTarget(PRM_META[(150, "out")] / name) for name in names_output
        ]
...
class WellChildVisits(PRMSASTask):  # pragma: no cover
    ...
    def output(self):
        names_output = {"results_well_child_visits.sas7bdat"}
        return [
            IndyPyLocalTarget(PRM_META[(150, "out")] / name) for name in names_output
        ]
...
class PrenatalPostpartumCare(PRMSASTask): # pragma: no cover
    ...
    def output(self):
        names_output = {
            "results_prenatal_care.sas7bdat",
            "results_postpartum_care.sas7bdat",
        }
        return [
            IndyPyLocalTarget(PRM_META[(150, "out")] / name) for name in names_output
        ]
...
class InjectCustomMeasures(PRMSASTask):  # pragma: no cover
    ...
    def output(self):
        names_output = {"prod41_inject_custom_measures.sas.complete"}
        return [
            IndyPyLocalTarget(PRM_META[(150, "out")] / name) for name in names_output
        ]
...
class CombineAll(PRMSASTask):  # pragma: no cover
    ...
    requirements = RequirementsContainer(InjectCustomMeasures)
...
def inject_dhs_assessments():  # pragma: no cover
    ...
    InjectCustomMeasures.add_requirements(AssessmentsForDHSChildren)
...
def inject_dental_measures():  # pragma: no cover
    ...
    InjectCustomMeasures.add_requirements(
        DentalSealant, DiabetesOralEval, DentalServices
    )
